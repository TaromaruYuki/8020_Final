        ...
        <Main>
            <div className="row g-5">
                <div className="col-md-5 col-lg-4 order-md-last">
                    ...
                    <ul className="list-group mb-3">
                        <li className="list-group-item d-flex justify-content-between lh-sm">
                            <div>
                            <h6 className="my-0">Safest Desk x1</h6>
                            <small className="text-muted">Making schooling safer for everyone.</small>
                            </div>
                            <i className="text-muted">$852.94</i>
                        </li>
                        <li className="list-group-item d-flex justify-content-between">
                            <span>Order & labor fee</span>
                            <i>$75</i>
                        </li>
                        <li className="list-group-item d-flex justify-content-between">
                            <span>Subtotal</span>
                ...
                <div className="col-md-7 col-lg-8">
                    ...
                    <LinkContainer to="/orderfinished">
                        <a className="w-100 btn btn-primary btn-lg">Order</a>
                    </LinkContainer>
                    </form>
                </div>
            </div>
